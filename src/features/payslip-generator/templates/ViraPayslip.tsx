...
export const ViraPayslip: React.FC<Props> = ({ data }) => {
  ...
  const earnings = [
    ...
    { label: "Bonus", full: formatNum(data.arrearsSalary ?? 0), actual: formatNum(data.arrearsSalary ?? 0) },
        ...
        <div className="main-box">
          <div className="info-section">
            ...
            <div className="info-col right-col">
              ...
              <InfoRow label="Bank Account No:" value={data.bankAccount} />
              <InfoRow label="IFSC Code:" value={data.ifscCode || 'NA'} />
